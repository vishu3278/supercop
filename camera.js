...
function saveImg(){
    ...
    var base64img = window.sessionStorage.getItem('canvas');
    var params = {data: base64img, prefix: 'card_', format: 'JPG'};
    window.imageSaver.saveBase64Image(params,
        function (filePath) {
          navigator.notification.alert('File saved on ' + filePath);
        },
        function (msg) {
          console.error(msg);
        }
